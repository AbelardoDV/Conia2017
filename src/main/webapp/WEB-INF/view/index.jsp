...
XIII Congreso Nacional de Ingeniería Agrícola</strong></p>
    ...
    <section id="conferencias" >
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2 class="section-heading">Conferencistas Magistrales</h2>
                    <h3 class="section-subheading text-muted">Se ha programado el desarrollo de un conjunto de conferencias magistrales a
cargo de profesionales de reconocida experiencia profesional y de
investigación.</h3>
                </div>
            </div>
            <div class="row text-center">
                <div class="col-md-4">
                    ...
                    <h4 class="service-heading">En construcción</h4>
    ...
    <aside class="clients">
     ...
     <section id="ubicacion">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2 class="section-heading">Sede de la comisión organizadora</h2>
                    <h3 class="section-subheading text-muted">Facultad de Ciencias Agrarias, de la

Escuela Profesional de Ingeniería Agrícola - UNASAM, Ciudad Universitaria</h3>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-6">
    ...
    <footer>
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                    <span class="copyright">Copyright &copy; CONIA 2017</span>
                </div>
                <div class="col-md-4">
                    <ul class="list-inline social-buttons">
